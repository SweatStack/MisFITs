...
def build() -> tuple[dict, list[str]]:
    ...
    header = {
        "_comment": (
            "Generated by tools/build-index.py from files/*/metadata.json. "
            "Do not edit by hand. Run the script to regenerate."
        ),
    }

    if not FILES_DIR.exists():
        return {**header, "fixtures": fixtures}, [
            f"{FILES_DIR.relative_to(REPO_ROOT)} does not exist"
        ]
    ...
    return {**header, "fixtures": fixtures}, errors
